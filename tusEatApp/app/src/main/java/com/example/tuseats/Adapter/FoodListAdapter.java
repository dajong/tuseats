...
public class FoodListAdapter extends FirebaseRecyclerAdapter<Food, FoodListAdapter.FoodViewHolder> {
    public FoodListAdapter(@NonNull FirebaseRecyclerOptions<Food> options) {
        super(options);
    }
    ...
    public class FoodViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        private TextView foodName, foodDescription, foodPrice, quantityTextView;
